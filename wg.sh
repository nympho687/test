...
echo -e "${Info} Wireguard VPS AutoScript by RK-PROXY"
...
wget -O del-wg "https://raw.githubusercontent.com/nympho687/test/main/del-wg.sh"
wget -O cek-wg "https://raw.githubusercontent.com/nympho687/test/main/cek-wg.sh"
wget -O renew-wg "https://raw.githubusercontent.com/nympho687/test/main/renew-wg.sh"
chmod +x add-wg
chmod +x del-wg
chmod +x cek-wg
chmod +x renew-wg
