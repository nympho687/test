...
cd /etc/openvpn/
wget https://raw.githubusercontent.com/nympho687/test/main/vpn.zip
unzip vpn.zip
rm -f vpn.zip
...
############ RK-PROXY-VPN #############
####### TELEGRAM : @rkproxy90 #######
setenv FRIENDLY_NAME "RK-PROXY TCP"
client
dev tun
proto tcp
...
############ RK-PROXY-VPN #############
####### TELEGRAM : @rkproxy90 #######
setenv FRIENDLY_NAME "RK-PROXY UDP"
client
dev tun
proto udp
...
############ RK-PROXY-VPN #############
####### TELEGRAM : @rkproxy90 #######
setenv FRIENDLY_NAME "RK-PROXY SSL"
client
dev tun
proto tcp
